...
#ifndef LMP_MLIAP_DESCRIPTOR_FITSNAP_H
#define LMP_MLIAP_DESCRIPTOR_FITSNAP_H

#include "mliap_descriptor.h"

namespace LAMMPS_NS {

class MLIAPDescriptorFitSNAP : public MLIAPDescriptor {
 public:
  MLIAPDescriptorFitSNAP(LAMMPS *, char *);
  ~MLIAPDescriptorFitSNAP() override;
